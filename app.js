...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      styleSrc: ["'self'", "'unsafe-inline'", 'https://fonts.googleapis.com', 'https://*.snapchat.com', 'https://sc-static.net'],
      fontSrc: ["'self'", 'https://fonts.gstatic.com', 'https://*.snapchat.com', 'https://sc-static.net'],
      imgSrc: ["'self'", 'data:', 'blob:', 'https://res.cloudinary.com', 'https://*.googletagmanager.com', 'https://*.google-analytics.com', 'https://tr.snapchat.com', 'https://*.snapchat.com', 'https://sc-static.net', 'https://*.sc-cdn.net'],
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", 'blob:', 'https://www.googletagmanager.com', 'https://*.googletagmanager.com', 'https://www.google-analytics.com', 'https://*.google-analytics.com', 'https://sc-static.net', 'https://*.sc-cdn.net', 'https://*.snapchat.com'],
      connectSrc: ["'self'", 'https://www.google-analytics.com', 'https://*.google-analytics.com', 'https://*.analytics.google.com', 'https://*.googletagmanager.com', 'https://tr.snapchat.com', 'https://*.snapchat.com', 'https://sc-static.net', 'https://*.sc-cdn.net'],
      frameSrc: ["'self'", 'blob:', 'https://*.snapchat.com', 'https://sc-static.net', 'https://*.sc-cdn.net', 'https://www.googletagmanager.com'],
      childSrc: ["'self'", 'blob:', 'https://*.snapchat.com', 'https://sc-static.net'],
      frameAncestors: ["'self'", 'https://*.snapchat.com', 'https://ads.snapchat.com', 'https://business.snapchat.com']
    }
  },
